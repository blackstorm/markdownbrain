...
│                                    # - Compiled to resources/publics/admin/css/admin.css
├── resources/
│   ├── templates/
...
**Note:** All design system styles are defined in `server/app.css` and compiled to `server/resources/publics/admin/css/admin.css`. When making style changes, edit `server/app.css` and run the CSS build process.
